        ...
        <main class="carrito">
            <div class="header-content container">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            <th class="micarro" scope="col">Trago</th>
                            <th class="micarro" scope="col">Detalles</th>
                            <th class="micarro" scope="col">Quitar?</th>
                        </tr>
                    </thead>
                    <%
                        double p_total = 0;
                    ...
                    <tr>
                        ...
                        <td>
                            <h5 class="micarro"> <%=x.getNom()%>.</h5>
                            <h5 class="micarro"> <%=x.getDescrip()%>.</h5>
                            <h5 class="micarro"> Cantidad: <%=x.getCant()%></h5>
                            <h5 class="micarro"> P.Acumulado: <%=x.getCost_acum()%></h5>
                        </td>
                        <td>
