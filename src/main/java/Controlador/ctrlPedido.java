...
public class ctrlPedido extends HttpServlet {
    ...
    HttpSession session=request.getSession();
      ...
      double costo=Double.parseDouble(request.getParameter("cost"));
      p.setCost_acum(cantidad*costo);
      p.setCant(cantidad);
      p.setCliente(request.getParameter("dni"));
